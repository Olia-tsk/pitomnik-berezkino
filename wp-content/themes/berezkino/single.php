    ...
    <div class="container">
        <details>
            ...
            <ul>
                ...
                <li><span>*</span> Возраст саженцев указан в количестве лет</li>
                <li><span>*</span> Конечная стоимость саженца зависит от характеристик конкретного растения: его высоты, возраста, наличия прививок, объёма горшка или диаметра кома и др.</li>
            </ul>
